...
import type { Motif, Theme, ThemeId } from "../types.js";
...
const CODE_VIBES_MOTIFS: readonly Motif[] = [
  { id: "git", label: "Git" },
...
const GAMING_MOTIFS: readonly Motif[] = [
...
/** Food motifs. */
const FOODS_MOTIFS: readonly Motif[] = [
 ...
 */
export function motifSrc(themeId: ThemeId, motifId: string): string {
